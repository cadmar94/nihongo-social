// netlify/functions/populate-database.js
// Function to populate MongoDB with initial posts
...
exports.handler = async (event, context) => {
  ...
  try {
    ...
    // Insert new posts
    const insertResult = await collection.insertMany(initialPosts);
    console.log(`Inserted ${insertResult.insertedCount} posts`);
